...
export const Profile = ({ user }: { user: any }) => {
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Update all bookings for this student to reflect profile changes
        ...
        <div className="relative z-10 flex items-center gap-10">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-500 mb-6 font-medium">
              {user?.role === 'student' ? 'Student' : 'Landlord'} Member since {user?.created_at ? new Date(user.created_at).getFullYear() : '2025'}
            </p>

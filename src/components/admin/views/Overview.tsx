...
export const Overview: React.FC = () => {
  ...
  const statCards = [
    ...
    { label: 'Monthly Revenue', value: `₱${stats.monthlyRevenue.toLocaleString()}`, icon: <CircleDollarSign className="w-6 h-6" />, color: 'bg-orange-500' },
    ...
    <div className="space-y-8">
      ...
      <div className="bg-slate-900 p-8 rounded-[32px] border border-white/10 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-400 font-medium">Here's what's happening on SafeStay today.</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h5 className="font-bold text-slate-900">Supabase</h5>
                <p className="text-xs text-slate-500 font-medium">Primary Database</p>
              </div>
            </div>
          ...
          <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h5 className="font-bold text-slate-900">Facebook Login</h5>
                <p className="text-xs text-slate-500 font-medium">Secondary Auth Provider</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 bg-orange-500 rounded-full"></span>
              <span className="text-xs font-bold text-orange-600 uppercase tracking-widest">Setup Required</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        {/* Platform Health */}
        <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm">
          <h4 className="text-lg font-bold text-slate-900 mb-8">Platform Health</h4>
          <div className="space-y-4">
            {[
              { label: 'System Uptime', value: '99.99%', color: 'text-emerald-500' },
              { label: 'Active Users', value: stats.totalUsers.toLocaleString(), color: 'text-slate-900' },
              { label: 'Pending Tasks', value: stats.pendingVerifications.toLocaleString(), color: 'text-amber-500' },
              { label: 'Security Score', value: 'A+', color: 'text-emerald-500' },
            ].map((item, i) => (

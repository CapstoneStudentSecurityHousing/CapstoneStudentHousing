            ...
            <div className="p-8 grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-slate-900 font-medium">{(selectedUser as any).phone_number || (selectedUser as any).phone || 'N/A'}</p>
                </div>
                <div>
                ...
                {selectedUser.role === 'landlord' && (
                  <div className="pt-4 border-t border-slate-50 space-y-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <p className="text-[10px] font-bold text-slate-400 uppercase mb-1">Tax ID</p>
                          <p className="text-sm font-bold text-slate-900">{(selectedUser as any).tax_id || 'N/A'}</p>
                        </div>
                        <div>

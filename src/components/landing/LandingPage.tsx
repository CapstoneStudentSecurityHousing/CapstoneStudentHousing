    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="h-24 px-10 flex items-center justify-between border-b border-slate-50 sticky top-0 bg-white/80 backdrop-blur-md z-50">
        <div className="flex items-center gap-2">
          ...
          <span className="text-2xl font-black text-slate-900 tracking-tighter">SafeStay</span>
        </div>
      ...
      <section className="py-24 bg-slate-100 px-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-4xl font-black text-slate-900">Quick Checkout Order (Supabase)</h2>
            <p className="text-slate-500">Submit order/checkout details and store in your Supabase orders table instantly.</p>
          </div>
          <OrderForm />
        </div>
      </section>
      ...
      <footer className="py-10 px-10 border-t border-slate-100 flex justify-between items-center">
        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">© 2024 SafeStay Baguio. All rights reserved.</p>
        <button 

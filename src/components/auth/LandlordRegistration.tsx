  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center py-12 px-6">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-500 max-w-md">Create your easy account. Additional business verification will be required after login.</p>
      </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    className={`w-full px-4 py-3 bg-white border ${errors.password ? 'border-rose-500' : 'border-slate-200'} rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all pr-12`}
                  />
                  <button
                    type="button"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    className={`w-full px-4 py-3 bg-white border ${errors.confirmPassword ? 'border-rose-500' : 'border-slate-200'} rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all pr-12`}
                  />
                  <button
                    type="button"
      ...
      <button className="fixed bottom-8 right-8 z-50 flex items-center gap-3 px-6 py-3 bg-slate-900 text-white rounded-full shadow-2xl hover:scale-105 transition-all border border-white/10">
        <div className="relative">

...
interface AdminLoginProps {
  onEmailLogin: (email: string, password: string) => Promise<void>;
    // onGoogleLogin removed
  onBack: () => void;
  isAuthenticating?: boolean;
}

export const AdminLogin: React.FC<AdminLoginProps> = ({ onEmailLogin, onBack, isAuthenticating = false }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="text-center mb-8 relative z-10">
        ...
        <p className="text-slate-400 font-medium">Secure administrative access for SafeStay</p>
      </div>
      ...
      >
        ...
        <button 
          onClick={onBack}
          className="w-full flex items-center justify-center gap-4 py-4 bg-white text-slate-900 rounded-2xl hover:bg-slate-100 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-white/5"
        >
